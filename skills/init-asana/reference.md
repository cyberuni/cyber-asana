...
**Credentials are not interchangeable:** MCP OAuth tokens from the official server cannot be used as `ASANA_TOKEN`. PATs cannot substitute for official MCP OAuth.
